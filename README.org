...
**** See the "random-forest" repository [[https://github.com/mpudil/random-forest][here]] to view the code for creating Random Forests from scratch, and SQL decision trees.
