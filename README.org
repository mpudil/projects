...
*** Economics Projects
    ...
    | [[file:Violence_in_the_Household.pdf][Crime and Divorce]]  |  Stata| Linear regression, fixed effects | Determine effect of maternal education on odds of child being homeschooled (working paper) | Apr 2018  | Yes (paper only) |
