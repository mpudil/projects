...
** Featured projects:
    ...
    |------------+--------+---------------------------------------------|
    | [[file:EnglishProficiency][English Proficiency]] |  R | NLP, PCA, Random Forest, Shiny | Determine probability of individual passing the TOEFL exam. Includes GUI interface for student to write essay.
